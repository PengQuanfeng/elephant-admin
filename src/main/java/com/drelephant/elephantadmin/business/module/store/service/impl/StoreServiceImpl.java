...
public class StoreServiceImpl implements StoreService {
    ...
    @Autowired
    private InspectItemClient inspectItemClient;
    @Autowired
    ...
    public R getAllPkgAndDeptByCondition(StorePkgAndDeptQueryRequest request) {
        Result<List<InspectItemAndDeptListResponse>> pKg = inspectItemClient.getAllItemAndDeptByCategoryCode(request.getCategoryCode());
        if (!pKg.checkCode()) {
